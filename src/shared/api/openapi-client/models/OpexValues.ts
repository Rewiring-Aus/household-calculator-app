...
export function OpexValuesToJSON(json: any): OpexValues {
    return OpexValuesToJSONTyped(json, false);
}

export function OpexValuesToJSONTyped(value?: OpexValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
